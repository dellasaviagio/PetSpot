O projeto foi construído em ReactNative utilizando a ferramenta Expo para facilitar a execução do aplicativo, possibilitando a visualização das alterações em tempo real sem a necessiade de um emulador.
